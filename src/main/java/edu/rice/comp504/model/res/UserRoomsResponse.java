...
public class UserRoomsResponse extends AResponse {
    ...
    private HashMap<Integer, String> joinedRooms;
    private HashMap<Integer, String> availableRooms;
    ...
    public UserRoomsResponse(int userId,
                             ...
                             HashMap<Integer, String> joinedRooms,
                             HashMap<Integer, String> availableRooms) {
        super("UserRooms");
        this.userId = userId;
